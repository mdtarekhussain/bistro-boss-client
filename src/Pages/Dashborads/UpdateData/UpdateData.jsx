...
const UpdateData = () => {
  const { name, price, recipe, _id, category } = useLoaderData();
  console.log(name, price, recipe, _id, category);
  ...
  return (
    <div>
      <Section heading="Updated Item" subHeading="What's now ?"></Section>
      <div className=" p-8 bg-[#F3F3F3] mt-5 rounded-lg">
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <button className="btn mt-3 bg-[#835D23] text-[18px]">
            {" "}
            Updated Item <FaUtensils className="ml-2"></FaUtensils>
          </button>
        </form>
      </div>
    </div>
